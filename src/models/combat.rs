...
pub struct WeaponSet {
    pub ranged_weapons: Vec<Weapons>,
    pub melee_weapons: Vec<Weapons>,
}
...
pub struct Model {
    pub name: String,
    pub stats: Stats,
    pub ranged_weapon: Option<Weapons>,
    pub melee_weapon: Option<Weapons>,
    pub tags: Vec<String>,
}
...
impl Unit {
    pub fn new(name: &str, points: i16, models: Vec<Model>, tags: Option<Vec<String>>) -> Self {
        Unit {
            name: name.to_string(),
            points,
            models,
    ...
    pub fn movement(&self, distance: i8) -> i8 {
        let movement = distance - self.models[0].stats.movement;
        if movement <= 0 {
            0
        } else {
            movement
